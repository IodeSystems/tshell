...
public class TShellParser extends Parser {
	...
	public static final int
		...
		ALL=17, RACE=18, ANY=19, PIPE_RIGHT=20, PIPE_SCATTER=21, PIPE_LEFT=22, 
		PIPE=23, ARROW=24, SPREAD=25, INCREMENT=26, DECREMENT=27, PLUS_ASSIGN=28, 
		MINUS_ASSIGN=29, STAR_ASSIGN=30, SLASH_ASSIGN=31, PERCENT_ASSIGN=32, PLUS=33, 
		MINUS=34, STAR=35, REGEX=36, SLASH=37, PERCENT=38, SEQ=39, SNEQ=40, EQ=41, 
		NEQ=42, LTE=43, GTE=44, LT=45, GT=46, AND=47, OR=48, NULLISH=49, NOT=50, 
		OPTIONAL_CHAIN=51, ASSIGN=52, QUESTION=53, COLON=54, DOT=55, COMMA=56, 
		SEMI=57, LPAREN=58, RPAREN=59, LBRACKET=60, RBRACKET=61, LBRACE=62, RBRACE=63, 
		NUMBER=64, STRING=65, TEMPLATE_START=66, IDENTIFIER=67, WS=68, LINE_COMMENT=69, 
		BLOCK_COMMENT=70, TEMPLATE_TEXT=71, TEMPLATE_EXPR=72, TEMPLATE_END=73;
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6198079073069039214L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 15L) != 0)) {
				{
				{
				setState(108);
				statement();
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 13)) & ~0x3f) == 0 && ((1L << (_la - 13)) & 34516006468583551L) != 0)) {
				{
				setState(235);
				expression();
				}
	...
	public final PostfixOpContext postfixOp() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 13)) & ~0x3f) == 0 && ((1L << (_la - 13)) & 34516006468587647L) != 0)) {
					{
					setState(458);
					argumentList();
					}
	...
	public final ObjectLiteralContext objectLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1152921504641449982L) != 0) || _la==IDENTIFIER) {
				{
				setState(554);
				objectField();
				setState(559);
	...
	public final FieldNameContext fieldName() throws RecognitionException {
		...
		try {
			...
			setState(584);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1048574L) != 0) || _la==IDENTIFIER) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		"\b.\u0003.\u0236\b.\u0001.\u0001.\u0001/\u0001/\u0001/\u0001/\u0001/\u0001"+
		"/\u0001/\u0001/\u0001/\u0001/\u0001/\u0001/\u0001/\u0003/\u0247\b/\u0001"+
		"0\u00010\u00011\u00031\u024c\b1\u00011\u00011\u00012\u00012\u00052\u0252"+
		"\b2\n2\f2\u0255\t2\u00012\u00012\u00013\u00013\u00013\u00013\u00013\u0003"+
		"3\u025e\b3\u00014\u00014\u00014\u00054\u0263\b4\n4\f4\u0266\t4\u00015"+
		"\u00015\u00015\u00015\u00035\u026c\b5\u00015\u0000\u00006\u0000\u0002"+
		"\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e"+
