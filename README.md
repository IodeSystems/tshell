...
**Total stdlib context cost: 5.8KB / 1641 tokens** (cl100k_base — tool description + syntax reference + command signatures)
...
| --- | ---: | --- |
| Tool description | 112 | One-line summary in the tool schema |
| Syntax reference | 403 | JS subset, pipes, raw templates, composition |
| Command signatures | 1098 | All stdlib commands with types and descriptions |
| **Total** | **1641** | **5.8KB** |
