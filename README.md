...
**Total stdlib context cost: 5.4KB / 1528 tokens** (cl100k_base — tool description + syntax reference + command signatures)
...
| --- | ---: | --- |
| Tool description | 82 | One-line summary in the tool schema |
